  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute right-full mr-3 bg-white text-neutral-900 px-3 py-1.5 rounded-lg text-sm font-medium shadow-xl opacity-0 translate-x-4 pointer-events-none transition-all group-hover:opacity-100 group-hover:translate-x-0 whitespace-nowrap">
          Falar com atendente
        </span>
      </a>
    </>
